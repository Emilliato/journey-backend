        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Learners_AspNetUsers_ParentId",
                        column: x => x.ParentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConversationSessions_Learners_LearnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Goals_Learners_LearnerId",
                        column: x => x.LearnerId,
                        principalTable: "Learners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredSubjectsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningProfiles_Learners_LearnerId",
                        column: x => x.LearnerId,
                        principalTable: "Learners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParentalConsents_AspNetUsers_ParentId",
                        column: x => x.ParentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParentalConsents_Learners_LearnerId",
                        column: x => x.LearnerId,
                        principalTable: "Learners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "JourneyMemories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LearnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ConversationSessionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JourneyMemories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JourneyMemories_ConversationSessions_ConversationSessionId",
                        column: x => x.ConversationSessionId,
                        principalTable: "ConversationSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JourneyMemories_Learners_LearnerId",
                        column: x => x.LearnerId,
                        principalTable: "Learners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessAuditLogs_LearnerId",
                table: "AccessAuditLogs",
                column: "LearnerId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessAuditLogs_OccurredAt",
                table: "AccessAuditLogs",
                column: "OccurredAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationSessions_LearnerId",
                table: "ConversationSessions",
                column: "LearnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Goals_LearnerId",
                table: "Goals",
                column: "LearnerId");

            migrationBuilder.CreateIndex(
                name: "IX_JourneyMemories_ConversationSessionId",
                table: "JourneyMemories",
                column: "ConversationSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_JourneyMemories_LearnerId",
                table: "JourneyMemories",
                column: "LearnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningProfiles_LearnerId",
                table: "LearningProfiles",
                column: "LearnerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParentalConsents_LearnerId",
                table: "ParentalConsents",
                column: "LearnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ParentalConsents_ParentId",
                table: "ParentalConsents",
                column: "ParentId");
        }
